...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="/jxspp/css/seastyle.css" rel="stylesheet" type="text/css" />

		<script type="text/javascript" src="/jxspp/basic/js/jquery-1.7.min.js"></script>
		<script type="text/javascript" src="/jxspp/js/script.js"></script>
	</head>
					...
					<div class="am-g am-g-fixed">
						<div class="am-u-sm-12 am-u-md-12">
							<div class="search-content">
								...
								<#if productsBySearchList??>
									<#list productsBySearchList as product>
										<li>
			...
			<div id="sidebar">
				<div id="wrap">
					...
					<div id="brand" class="item">
						<a href="#">
							<span class="wdsc"><img src="/jxspp/images/wdsc.png" /></span>
						</a>
						<div class="mp_tooltip">
							我的收藏
							<i class="icon_arrow_right_black"></i>
					...
					<div id="broadcast" class="item">
						<a href="#">
							<span class="chongzhi"><img src="/jxspp/images/chongzhi.png" /></span>
						</a>
						<div class="mp_tooltip">
							我要充值
							<i class="icon_arrow_right_black"></i>
					...
					<div class="quick_toggle">
						...
						<li class="qtitem">
							...
							<div class="mp_qrcode" style="display:none;"><img src="/jxspp/images/weixin_code_145.png" /><i class="icon_arrow_white"></i></div>
						</li>
						<li class="qtitem">
